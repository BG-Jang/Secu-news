...
**같은 날짜 복수 호 지원**: 파일명에 pm / am / privacy / special 토큰을 넣으면 같은 날짜의 별개 호로 목록에 함께 표시되고 라벨(저녁판·아침판·개인정보 결산·특집)이 붙습니다. 딥링크는 #/2026-09-03-pm/1 형식. 같은 날짜+같은 슬러그 중복 시 정렬상 마지막 파일 채택.
